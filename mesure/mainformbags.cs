...
namespace mesure
{
    ...
    {// element pas a sauvegarder dans fichier
        ...
        public string m_autoSaveResPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
    ...
    {// elements de donnees
        ...
        public string m_ResPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
