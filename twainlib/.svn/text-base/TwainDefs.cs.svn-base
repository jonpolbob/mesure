...
internal class TwPendingXfers
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    internal struct TwSetupMemXfer
    {
    public uint MinBufSize; /* Minimum buffer size in bytes */
    public uint MaxBufSize; /* Maximum buffer size in bytes */
    public uint Preferred; /* Preferred buffer size in bytes */
    }


    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    public struct TwMemory
    {
    public uint  Flags;
    public uint Length;
    IntPtr TheMem;
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    internal struct TwimageMemXfer
    {
